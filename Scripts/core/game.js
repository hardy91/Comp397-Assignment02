...
(function () {
    ...
    var Manifest = [
        ...
        { id: "thunder", src: "/Assets/audio/bomb-02.ogg" },
        { id: "engine", src: "/Assets/audio/airstrike.mp3" },
        { id: "parallax-bg", src: "/Assets/images/city_twilight_bg.png" },
        { id: "plane", src: "/Assets/images/tornado-jet-plane-small.png" },
        { id: "enemy", src: "/Assets/images/enemy-plane.png" },
    ];
    function SetupStats() {
        stats.showPanel(0);
